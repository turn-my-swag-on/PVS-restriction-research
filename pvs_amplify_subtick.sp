...
{
name = "PVS Amplify Research Plugin",
...
// Spotted cache
new bool:g_bSpotted[MAX_PLAYERS+1];
...
native Float:GetVectorDistance(const Float:v1, const Float:v2)
{
